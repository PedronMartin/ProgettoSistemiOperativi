...
bin/$(CLIENT_BIN): $(CLIENT_OBJ) $(ERREXIT_OBJ) $(TRISTRUCT_OBJ) $(SIGNAL_OBJ)
	@$(CC) $(CLIENT_OBJ) $(ERREXIT_OBJ) $(TRISTRUCT_OBJ) $(SIGNAL_OBJ) -o bin/$(CLIENT_BIN)
	@echo "\nFile " $@ " pronto per l'esecuzione...\n"

#regola di compilazione del server
bin/$(SERVER_BIN): $(SERVER_OBJ) $(ERREXIT_OBJ) $(TRISTRUCT_OBJ) $(SIGNAL_OBJ)
	@$(CC) $(SERVER_OBJ) $(ERREXIT_OBJ) $(TRISTRUCT_OBJ) $(SIGNAL_OBJ) -o bin/$(SERVER_BIN)
	@echo "\nFile " $@ " pronto per l'esecuzione...\n"

#regola di compilazione del bot
bin/$(TRIBOT_BIN): $(TRIBOT_OBJ) $(ERREXIT_OBJ) $(TRISTRUCT_OBJ) $(SIGNAL_OBJ)
	@$(CC) $(TRIBOT_OBJ) $(ERREXIT_OBJ) $(TRISTRUCT_OBJ) $(SIGNAL_OBJ) -o bin/$(TRIBOT_BIN)
	@echo "\nFile " $@ " pronto per l'esecuzione...\n"
